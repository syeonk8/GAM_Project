...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var locationRequest: LocationRequest// 위치 요청
    private lateinit var locationCallback: LocationCallback// 내부 클래스, 위치 변경 후 지도에 표시.*/


    private lateinit var fusedLocationProviderClient: FusedLocationProviderClient
    // 위치값 얻어오기 객체
    private lateinit var locationRequest: LocationRequest // 위치 요청
    private lateinit var locationCallback: MyLocationCallBack // 내부 클래스, 위치 변경 후 지도에 표시.
